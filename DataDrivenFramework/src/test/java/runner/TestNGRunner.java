...
public class TestNGRunner {
	...
	*/ 
	...
	XmlTest test; // 1 test case
	List<XmlTest> testCases; // all testcases under suite
	...
	public void addTest(String testName) {
		...
		test.setParameters(testParameters);// blank parameters
		test.setXmlClasses(testClasses);// blank classes
